function Prediction = RVR_NFolds_Sort(Subjects_Data, Subjects_Scores, FoldQuantity, Pre_Method, Weight_Flag, Permutation_Flag, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
%
% Subject_Scores:
%           m*1 vector, the continuous variable to be predicted
%
% FoldQuantity: 
