function Prediction = SVR_NFolds_RandomCV(Subjects_Data, Subjects_Scores, FoldQuantity, Pre_Method, C_Parameter, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
if nargin >= 6
    ...
    % Calculating w
    W_Calculate_SVR(Subjects_Data, Subjects_Scores, Pre_Method, C_Parameter, ResultantFolder); 
end
